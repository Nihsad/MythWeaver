const title = 'Echoes of Eldoria: The Enchanted Labyrinth';
const author = 'storyWeaver';
const description = 'Venture into the mystical labyrinth of Eldoria, a maze of magic and mystery hidden deep within the heart of the enchanted forest. As a courageous adventurer seeking fame and fortune, you must navigate through twisting passages, evade cunning traps, and outsmart mythical guardians to uncover the secrets buried within.';
const imageUrl = '/images/test-img-3.jpg';
const price = 0;
