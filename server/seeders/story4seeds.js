const title = 'The Lost Relic of Arcane';
const author = 'fantasyBard';
const description = 'Dive into the mythical realm of Arcadia, where the ancient Arcane Kingdom once thrived. As a valiant warrior seeking glory, you embark on a quest to recover the lost relic of King Arcturus, a powerful artifact said to hold the key to restoring peace to the fractured lands.';
const imageUrl = '/images/test-img-4.jpg';
const price = 0;
