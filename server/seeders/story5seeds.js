const title = `The Phoenix's Flight`;
const author = 'mythicNarrator';
const description = 'Soar through the skies of the Celestial Isles, a realm of floating islands and ancient magic. As a fledgling sky captain, you are tasked with a daring mission: to capture the elusive Phoenix and harness its legendary powers. Will you capture the Phoenix and become a legend of the skies, or will you falter and fade into obscurity?';
