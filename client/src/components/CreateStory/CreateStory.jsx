    ...
    const handleStorySubmit = async () => {
        ...
        try {
            const data = await addStory({
                variables: {
                    title,
                    // we would grab the user's username for author in the future
                    author,
                    description,
                    imageUrl,
                    price,
    ...
    return (
        <div className="create-story-container">
            ...
            <div className="create-story-content">
                ...
                <div>
                    <button class='submit-story-test-btn' onClick={handleStorySubmit}>Test Button</button>
                </div>
